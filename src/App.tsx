...
const App: React.FC = () => {
  ...
  return (
    <body className="leading-normal tracking-normal text-indigo-400 bg-cover bg-fixed" style={{ backgroundImage: `url(https://przemyslawsarnacki.github.io/air-predictor/header.png)` }}>
